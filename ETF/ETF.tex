...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file '../Data/Rate.csv': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.Date(da\$Time.Period, format = "{}\%Y-\%m-\%d"{}): object 'da' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(da\$Date, da[, 2], type = "{}l"{}, main = "{}US Official Interest Rate"{}, : object 'da' not found}}\end{kframe}
\end{knitrout}
\end{frame}
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in file(file, "{}rt"{}): cannot open file '../Data/Res.csv': No such file or directory}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in file(file, "{}rt"{}): cannot open the connection}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in as.Date(da2\$DATE, format = "{}\%Y-\%m-\%d"{}): object 'da2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval(expr, envir, enclos): object 'da2' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in plot(da2\$Date, da2\$WALCL, type = "{}l"{}, main = "{}Total Assets of the \textbackslash{}n\ \ \ \  US Federal Reserve"{}, : object 'da2' not found}}\end{kframe}
\end{knitrout}
\end{frame}
